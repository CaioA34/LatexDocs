...
\preambulo
{%
	Trabalho de Conclusão de Curso de Graduação em Ciência da Computação do Pontífice Universidade Católica de Goiás como requisito para a obtenção~do~título~de~\imprimirformacao.
}
% ---
