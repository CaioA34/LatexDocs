...
\autor{Caio Almeida Oliveira}
% FIXME Substituir 'Título do trabalho' pelo título da trabalho.
\titulo{Estudo de Caso 1}
% Substituir 'Subtítulo (se houver)' pelo subtítulo da trabalho. 
% Se não houver subtítulo, basta deletar o texto.
\subtitulo{Cálculo de \texorpdfstring{$\pi$}{pi} e Análise de Erro}

\orientador{Prof. André L. C. da Silva}
...
\preambulo
{%
	Trabalho de Fundamentos da Computação IV do Curso de Graduação em Ciência da Computação do Pontífice Universidade Católica de Goiás como requisito para a obtenção~do~título~de~\imprimirformacao.
}
% ---
